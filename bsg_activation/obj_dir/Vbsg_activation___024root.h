...
class Vbsg_activation___024root final : public VerilatedModule {
  public:
    ...
    VL_IN(ang_i,19,0);
    VL_OUT(data_o,31,0);
    IData/*19:0*/ bsg_activation__DOT__ang_r;
    ...
    VlWide<14>/*419:0*/ bsg_activation__DOT__sinhcosh__DOT__ang;
    ...
    VlWide<13>/*399:0*/ bsg_activation__DOT__sinhcosh__DOT__ang_ans;
