...
VL_INLINE_OPT void Vbsg_tanh___024root___sequent__TOP__0(Vbsg_tanh___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbsg_tanh__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vbsg_tanh___024root___sequent__TOP__0\n"); );
    // Init
    ...
    IData/*20:0*/ __Vdly__bsg_tanh__DOT__ang_r;
    CData/*5:0*/ __Vdly__bsg_tanh__DOT__divider__DOT__control__DOT__calc_cnt;
    // Body
    __Vdly__bsg_tanh__DOT__ang_r = vlSelf->bsg_tanh__DOT__ang_r;
    ...
    if ((1U & (~ (IData)(vlSelf->bsg_tanh__DOT__sinhcosh__DOT__stall_pipe)))) {
        ...
        vlSelf->bsg_tanh__DOT__sinhcosh__DOT__val = 
            ((0x1ffffeU & vlSelf->bsg_tanh__DOT__sinhcosh__DOT__val) 
             | ((1U == (IData)(vlSelf->bsg_tanh__DOT__state_r)) 
    ...
    vlSelf->bsg_tanh__DOT__divider__DOT__control__DOT__add1_neg_last_r 
        = (1U & (IData)((vlSelf->bsg_tanh__DOT__divider__DOT__add1_out 
                         >> 0x30U)));
    vlSelf->bsg_tanh__DOT__data_r = (((8U == (IData)(vlSelf->bsg_tanh__DOT__divider__DOT__control__DOT__state)) 
                                      | (IData)(vlSelf->bsg_tanh__DOT__bypass))
                                      ? (((IData)(vlSelf->neg_sel_i) 
                                          & (~ (IData)(vlSelf->tanh_sel_i)))
                                          ? ((IData)(0x10000U) 
                                             - vlSelf->bsg_tanh__DOT__data_n)
                                          : vlSelf->bsg_tanh__DOT__data_n)
                                      : vlSelf->bsg_tanh__DOT__data_r);
    if (vlSelf->reset_i) {
        __Vdly__bsg_tanh__DOT__ang_r = 0U;
        __Vdly__bsg_tanh__DOT__divider__DOT__control__DOT__calc_cnt = 0U;
        vlSelf->bsg_tanh__DOT__divider__DOT__control__DOT__state = 0U;
    } else {
        __Vdly__bsg_tanh__DOT__ang_r = ((IData)(vlSelf->bsg_tanh__DOT__load_ang)
                                         ? vlSelf->ang_i
                                         : vlSelf->bsg_tanh__DOT__ang_r);
    ...
    vlSelf->bsg_tanh__DOT__ang_r = __Vdly__bsg_tanh__DOT__ang_r;
    vlSelf->bsg_tanh__DOT__divider__DOT__control__DOT__calc_cnt 
        = __Vdly__bsg_tanh__DOT__divider__DOT__control__DOT__calc_cnt;
    vlSelf->bsg_tanh__DOT__sinhcosh__DOT__ang_ans[0U] 
...
VL_INLINE_OPT void Vbsg_tanh___024root___combo__TOP__0(Vbsg_tanh___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbsg_tanh__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vbsg_tanh___024root___combo__TOP__0\n"); );
    // Init
...
void Vbsg_tanh___024root___eval(Vbsg_tanh___024root* vlSelf) {
    ...
    if (((IData)(vlSelf->clk_i) & (~ (IData)(vlSelf->__Vclklast__TOP__clk_i)))) {
        Vbsg_tanh___024root___sequent__TOP__0(vlSelf);
    }
    Vbsg_tanh___024root___combo__TOP__0(vlSelf);
    // Final
